...
#Region " QUERY EXECUTION "
        ...
        ' Retrieve a reader from the sql command.
        ' If you use a reader you muts remenber to close when you finish to use it.
        ' Also the user must manage the connection status, open and close.
        Public Function Reader(Sql As String) As DbDataReader
            ' Create the command
            Dim Command As DbCommand = Me.mConnection.CreateCommand()
            Command.CommandText = Sql
            Command.CommandTimeout = Me.mCommandTimeout
...
#Region " DATASET AND DATATABLE "
        ...
        Public Function Table(TableName As String) As DataTable
            ...
            Dim Command As String = New SqlBuilder(Me.GetProvider()) _
                .Table(TableName) _
                .SelectCommand
        ...
        Public Function CreateAdapter(ByVal TableName As String) As DbDataAdapter
            Try
                ...
                Command.CommandText = New SqlBuilder(Me.GetProvider).Table(TableName).Where(DB.Clauses.AlwaysFalse).SelectCommand
                Command.CommandTimeout = Me.mCommandTimeout
                Command.Transaction = Me.mTransaction
                ...
                CommandBuilder.QuotePrefix = SqlBuilder.QUOTE_PREFIX
                CommandBuilder.QuoteSuffix = SqlBuilder.QUOTE_SUFFIX
